...
export default function Header(){return <>
  ...
  <nav className="nav"><div className="wrap navlinks"><Link href="/">INÍCIO</Link><Link href="/pastorais">PASTORAIS</Link><Link href="/horarios">HORÁRIOS</Link><Link href="/liturgia">LITURGIA DIÁRIA</Link><Link href="/terco-virtual">TERÇO VIRTUAL</Link><Link href="/transmissao">AO VIVO</Link><Link href="/dizimo">DÍZIMO</Link><Link href="/intencoes">INTENÇÕES</Link><Link href="/agenda">AGENDA</Link><Link href="/noticias">NOTÍCIAS</Link><Link href="/contato">CONTATO</Link></div></nav>
</>}
